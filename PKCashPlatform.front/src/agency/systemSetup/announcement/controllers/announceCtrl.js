...
function(httpSvc, popupSvc, announceService, $stateParams, DTColumnBuilder, $http, $scope, $rootScope, APP_CONFIG,$state, $LocalStorage){
    //获取站点
    $scope.siteId = function (site_index_id) {
        announceService.getDropSelect(site_index_id).then(function (response) {
