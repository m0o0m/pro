angular.module('app.analysisExit').controller('ValidListCtrl', function(httpSvc,popupSvc,$http,$scope,$rootScope,$compile,APP_CONFIG,$state,$LocalStorage,AnalysisExitService){
    ...
    var GetAllEmployee = function () {
        ...
        AnalysisExitService.getValidList(postData).then(function (response) {
