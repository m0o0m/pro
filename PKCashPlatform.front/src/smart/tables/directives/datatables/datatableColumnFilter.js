...
angular.module('app.tables').directive('datatableColumnFilter', function () {
    return {
        ...
        link: function (scope, element, attributes) {
            ...
            // custom toolbar
            element.parent().find("div.toolbar").html('<div class="text-right"><img src="app/styles/img/logo.png" alt="SmartAdmin" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
