...
angular.module('app.tables').directive('jqGrid', function ($compile) {
    ...
    return {
        ...
        controller: function($scope, $element){
         console.log( $element.find('table').restoreRow())
            ...
            table.jqGrid({
                ...
                gridComplete : function() {
                    ...
                    for (var i = 0; i < ids.length; i++) {
                        ...
                        var ca_a = "<button class='btn btn-xs btn-default' uib-tooltip='按钮' tooltip-append-to-body='true' ng-click='sub("+ cl +")'>按钮</button>";
