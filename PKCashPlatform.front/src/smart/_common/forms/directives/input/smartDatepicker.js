        ...
        link: function (scope, element, attributes) {
            ...
            if (attributes.minRestrict) {
                onSelectCallbacks.push(function (selectedDate) {
                    $(attributes.minRestrict).datetimepicker('option', 'minDate', selectedDate);
                });
            }
            if (attributes.maxRestrict) {
                onSelectCallbacks.push(function (selectedDate) {
                    $(attributes.maxRestrict).datetimepicker('option', 'maxDate', selectedDate);
                });
            }
            ...
            if (attributes.timeFormat) options.timeFormat = attributes.timeFormat;
            ...
            options.showMillisec= false;
            options.showMicrosec= false;
            options.showTimezone= false;
