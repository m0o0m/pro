angular.module('app.copyEditor').controller('wapDiscountContentCtrl',
    function($scope,APP_CONFIG,$LocalStorage,CopyEditorService,popupSvc,$rootScope,$state,attachmentService,$stateParams){
        ...
        var GetAllEmployee = function () {
            ...
            CopyEditorService.getWapDiscount_C(postData).then(function (response) {
        ...
        $scope.sub = function () {
            ...
            CopyEditorService.getWapDiscount_C_M_S(postData).then(function (response) {
        ...
        $scope.addSub = function () {
            ...
            CopyEditorService.getWapDiscount_C_AddSub(postData).then(function (response) {
                console.log(response);
                if(response.data.data==null){
                    popupSvc.smallBox("success", $rootScope.getWord("success"));
                    GetAllEmployee();
        ...
        $scope.mContent = function (id) {
            $state.go('app.CopyEditor.wapContentModifyDiscount',{
                id:id
            })
        }
        ...
        $scope.submit = function () {
            CopyEditorService.getWapDiscount_C_Update({
                id: $scope.is_id,
                title: $scope.title,
                url: $scope.url
            }).then(function (response) {
        ...
        $scope.del = function (id) {
            var del_s = function () {
                ...
                CopyEditorService.getWapDiscount_C_Del(postData).then(function (response) {
                    if (response.data.data===null){
                        GetAllEmployee();
                        popupSvc.smallBox("success", $rootScope.getWord("success"));
                    } else {
        ...
        $scope.keep = function () {
            ...
            var keep = function () {
                var postData = {
                    id: $scope.site_index_id
                };
                CopyEditorService.getWapDiscount_C_Keep(postData).then(function (response) {
                    if (response.data.data===null){
                        GetAllEmployee();
                        popupSvc.smallBox("success", $rootScope.getWord("success"));
                    } else {
