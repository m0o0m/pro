// angular.module('app.copyEditor').controller('DepositEditorCtrl', function($scope,APP_CONFIG,$LocalStorage,CopyEditorService,popupSvc,$rootScope){
//
//
// });
angular.module('app.copyEditor').controller('DepositEditorCtrl',
    function ($compile, $scope, popupSvc, siteService, attachmentService, $rootScope, APP_CONFIG,CopyEditorService,$stateParams) {
        $scope.id = $stateParams.id;
        var postData = {
            id: $scope.id
        }
        CopyEditorService.getDepositEditor(postData).then(function (response) {
