angular.module('app.copyEditor').controller('DiscountCtrl',
    function($scope,APP_CONFIG,$LocalStorage,CopyEditorService,popupSvc,$rootScope,$state,attachmentService){
        ...
        var GetAllEmployee = function () {
            ...
            CopyEditorService.getDiscount(postData).then(function (response) {
        ...
        $scope.mWidth = function () {
            ...
            CopyEditorService.getDiscountWidthSub(postData).then(function (response) {
        ...
        $scope.sub = function () {
            ...
            CopyEditorService.getDiscountAddSub(postData).then(function (response) {
                console.log(response);
                if(response.data.data==null){
                    popupSvc.smallBox("success", $rootScope.getWord("success"));
                    GetAllEmployee();
        ...
        $scope.mContent = function (id) {
            $state.go('app.CopyEditor.ModifyDiscount',{
                id:id
            })
        };
        $scope.dContent = function (id) {
            $state.go('app.CopyEditor.discountContent',{
                id:id
            })
        };
        ...
        $scope.submit = function () {
            CopyEditorService.getDiscountUpdate({
                id: $scope.is_id,
                title: $scope.title,
                url: $scope.url
            }).then(function (response) {
        ...
        $scope.del = function (id) {
            var del_s = function () {
                ...
                CopyEditorService.getDiscountDel(postData).then(function (response) {
                    if (response.data.data===null){
                        GetAllEmployee();
                        popupSvc.smallBox("success", $rootScope.getWord("success"));
                    } else {
        ...
        $scope.keep = function () {
            ...
            var keep = function () {
                ...
                CopyEditorService.getDiscountKeep(postData).then(function (response) {
                    if (response.data.data===null){
                        GetAllEmployee();
                        popupSvc.smallBox("success", $rootScope.getWord("success"));
                    } else {
