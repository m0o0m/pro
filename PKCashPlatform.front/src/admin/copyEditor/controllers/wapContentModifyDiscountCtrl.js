angular.module('app.copyEditor').controller('wapContentModifyDiscountCtrl', function($compile,$scope, popupSvc, siteService, attachmentService, $rootScope, APP_CONFIG,CopyEditorService,$stateParams) {
    $scope.id = $stateParams.id;
    var postData = {
        id: $scope.id
    }
    CopyEditorService.getWapDiscount_C_M_C(postData).then(function (response) {
    ...
    $scope.submit = function () {
        ...
        CopyEditorService.getWapDiscount_C_M_Sub(postData).then(function (response) {
            console.log(response);
