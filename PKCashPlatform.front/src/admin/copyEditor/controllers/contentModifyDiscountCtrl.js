angular.module('app.copyEditor').controller('contentModifyDiscountCtrl', function($compile,$scope, popupSvc, siteService, attachmentService, $rootScope, APP_CONFIG,CopyEditorService,$stateParams) {
    $scope.id = $stateParams.id;
    var postData = {
        id: $scope.id
    }
    CopyEditorService.getDiscount_C_M_Content(postData).then(function (response) {
    ...
    $scope.submit = function () {
        ...
        CopyEditorService.getDiscount_C_M_Sub(postData).then(function (response) {
            console.log(response);
