angular.module('app.copyEditor').controller('ModifyDiscountCtrl', function($compile,$scope, popupSvc, siteService, attachmentService, $rootScope, APP_CONFIG,CopyEditorService,$stateParams) {
    $scope.id = $stateParams.id;
    var postData = {
        id: $scope.id
    }
    CopyEditorService.getDiscount_M_C(postData).then(function (response) {
    ...
    $scope.submit = function () {
        ...
        CopyEditorService.getDiscount_M_Sub(postData).then(function (response) {
            console.log(response);
