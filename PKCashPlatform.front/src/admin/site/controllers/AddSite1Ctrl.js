 ...
 */
angular.module('app.site').controller('AddSite1Ctrl', function(DTOptionsBuilder, DTColumnBuilder,$http,$scope,$state,$compile){
    var vm = this;
    activate();
    function activate() {
