...
class NoticebackModel extends \yii\base\Model {
    public static function getTableName(){
        return \Yii::$app->manage_db->tablePrefix . 'backend_notice';
    }
    ...
    public static function getAgentItems($table, $where, $select = '*') {
        return (new \yii\db\Query())
            ->select($select)
            ->from($table)
            ->where($where)
