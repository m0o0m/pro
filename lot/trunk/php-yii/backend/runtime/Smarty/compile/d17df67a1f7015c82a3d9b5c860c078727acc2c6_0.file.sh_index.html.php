<?php
/* Smarty version 3.1.31, created on 2018-02-10 11:00:16
  from "/Users/frank/www/newproject/trunk/php-yii/backend/views/agent/sh_index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5a7ed0c0686158_52743077',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd17df67a1f7015c82a3d9b5c860c078727acc2c6' => 
    array (
      0 => '/Users/frank/www/newproject/trunk/php-yii/backend/views/agent/sh_index.html',
      1 => 1517801681,
      2 => 'file',
    ),
  ),
...
function content_5a7ed0c0686158_52743077 (Smarty_Internal_Template $_smarty_tpl) {
?>
<style>
...
<div class="page-header col-xs-12">
    <div id="show-table_filter" class="dataTables_length">
        <form id="agent-form" method='get' action='/agent/shindex'>
...
>
    ...
    $('#create').click(function () {
        var url = '/agent/sh_edit?type=create';
    ...
    $('.update').click(function () {
        var id = $(this).attr('data');
        var url = '/agent/sh_edit?id=' + id + '&type=update';
        renderFormByPjax(url);
    })
    ...
    $('.role').click(function () {
        var id = $(this).attr('data');
        var type = $(this).attr('type');
        var url = '/agent/role?id=' + id + '&type=' + type + '&state=agent';
        renderFormByPjax(url);
    })
    ...
    $('.set_money').click(function () {
        var id = $(this).attr('data');
        var url = '/agent/money?id=' + id + '&type=user_sh';
        renderFormByPjax(url);
    })
