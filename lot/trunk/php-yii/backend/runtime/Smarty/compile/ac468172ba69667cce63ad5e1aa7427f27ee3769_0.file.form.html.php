<?php
/* Smarty version 3.1.31, created on 2018-02-10 11:00:52
  from "/Users/frank/www/newproject/trunk/php-yii/backend/views/agent/form.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5a7ed0e4ec8b26_31709446',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ac468172ba69667cce63ad5e1aa7427f27ee3769' => 
    array (
      0 => '/Users/frank/www/newproject/trunk/php-yii/backend/views/agent/form.html',
      1 => 1517801681,
      2 => 'file',
    ),
  ),
...
function content_5a7ed0e4ec8b26_31709446 (Smarty_Internal_Template $_smarty_tpl) {
?>
<style>
...
>
            ...
            <?php if (!empty($_smarty_tpl->tpl_vars['ua_data']->value)) {?>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                 <select type="select" name="ua_id"  id="ua-select" style="display:block;">
                    <option value="" >全部</option>
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ua_data']->value, 'v', false, 'k');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['v']->value) {
?>
                    <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
echo $_smarty_tpl->tpl_vars['data']->value['login_name'];
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
				<textarea rows="3" cols="30" id='login_ip' class="col-xs-10 col-sm-5"><?php if (isset($_smarty_tpl->tpl_vars['data']->value['login_ip'])) {
