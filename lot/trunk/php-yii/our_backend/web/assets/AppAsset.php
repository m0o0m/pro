...
namespace our_backend\assets;

use yii\web\AssetBundle;

/**
 * Main our_backend application asset bundle.
 */
class AppAsset extends AssetBundle
{
    ...
    {
        $options = ['depends' => 'our_backend\assets\AppAsset'];
...
//            'js/x-editable/ace-editable.min.js',
     ...
     * @param array $options
     */
    public static function loadDataTables($view, $arrNoLoad = [], $options = ['depends' => 'our_backend\assets\AppAsset'])
    {
        // 必须加载的JS
        $arrLoad = [
            // 主要的CSS 和 javascript
     ...
     * @param array $options
     */
    public static function loadTimeJavascript($view, $type = 'all', $options = ['depends' => 'our_backend\assets\AppAsset'])
    {
        // 按需加载的CSS
        $arrCss = [
