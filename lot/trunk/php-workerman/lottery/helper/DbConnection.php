        ...
        try {
            ...
            if ($e->errorInfo[1] == 2006 || $e->errorInfo[1] == 2013) {
                ...
                try {
                    ...
                    $this->rollBackTrans();
                    Common_helper::write_error_log($query . PHP_EOL . $parameters . PHP_EOL . $ex, 3, 'lsql.txt');
                    throw $ex;
                }
            } else {
                $this->rollBackTrans();
                Common_helper::write_error_log($query . PHP_EOL . $parameters . PHP_EOL . $e, 3, 'lsql_2.txt');
                throw $e;
            }
        }
        $this->parameters = array();
