    ...
    },
    {
      object: [
        ...
        },
        {
          money: '',
          flag: false,
          color: "linear-gradient(#2e9fe6,#66c8f3)",
          // img_src: require("../../../assets/img/pcdd_blue.png"),
          li_id: 12,
          class:['双','小','边','小双','小边','双边','大尾','8尾','3余2','4余0','5余3']
        },
        ...
        },
        {
          ...
          flag: false,
          color: "linear-gradient(#3ec948, #026d09)",
          // img_src: require("../../../assets/img/pcdd_yellogreen.png"),10
          li_id: 14,
          class:['双','小','中','小双','小尾','0尾','3余1','4余2','5余0']
        },
        {
        ...
        },
        {
          money: '',
          flag: false,
          color: "linear-gradient(#b3f176, #8ae92d)",
      ...
      object: [
        {
          ...
          flag: false,
          color: "linear-gradient(#b3f176, #8ae92d)",
          // img_src: require("../../../assets/img/pcdd_lightgreen.png"),14
          li_id: 22,
          class:['双','大','中','大双','小尾','4尾','3余2','4余2','5余4']
        },
        {
        ...
        },
        {
          ...
          flag: false,
          color: "linear-gradient(#2e9fe6,#66c8f3)",
          // img_src: require("../../../assets/img/pcdd_blue.png"),17
          li_id: 25,
          class:['单','大','中','大单','大尾','7尾','3余2','4余1','5余2']
        },
        {
      ...
      object: [
        {
          ...
          flag: false,
          color: "linear-gradient(#ee4c19, #bd2706)",
          // img_src: require("../../../assets/img/pcdd_red.png"),21
          li_id: 32,
          class:['单','大','边','大双','大边','单边','小尾','1尾','3余0','4余1','5余1']
        },
        {
        ...
        },
        {
          ...
          flag: false,
          color: "linear-gradient(#ee4c19, #bd2706)",
          // img_src: require("../../../assets/img/pcdd_red.png"),24
          li_id: 35,
          class:['双','大','边','大双','大边','双边','小尾','4尾','3余0','4余0','5余4']
        },
        {
...
//        },60000)
    ...
    computed: function(data) {
      ...
      this.luckyLists = [];
      if (this.$route.query.page == "bj_28") {
        //PKBj28
        // this.luckyLists=[];
        this.luckyLists = PKBj28();

        var k = 0;
        for (let l = 0; l < this.luckyLists.length; l++) {
          for (let i = 0; i < this.luckyLists[l].object.length - 1; i++, k++) {
        ...
        for (let l = 0; l < this.luckyLists.length; l++) {
          for (let i = 7; i < this.luckyLists[l].object.length; i++, k++) {
            Object.assign(this.luckyLists[l].object[i], data[k]);
            let name = data[k].remark.slice(
              data[k].remark.search("#") + 1,
              data[k].remark.length
      ...
      else if(this.$route.query.page == 'pc_28') {
        this.pcdd = pcEggEgg(); //pcEggEggT
        var k = 0;
        for (let l = 0; l < this.pcdd.length; l++) {
          for (let i = 0; i < 7; i++, k++) {
            Object.assign(this.pcdd[l].object[i], data[k]);
            let name = data[k].remark.slice(
              data[k].remark.search("#") + 1,
              data[k].remark.length
            );
            this.pcdd[l].object[i].name = name;
          }
        }
        for (let l = 1; l < this.pcdd.length; l++) {
          k = 28 + l;
          for (let i = 7; i < this.pcdd[l].object.length; i++, k += 4) {
            Object.assign(this.pcdd[l].object[i], data[k]);
            let name = data[k].remark.slice(
              data[k].remark.search("#") + 1,
              data[k].remark.length
        ...
        k = 28;
        for (let i = 7; i < this.pcdd[0].object.length - 1; i++, k += 4) {
          Object.assign(this.pcdd[0].object[i], data[k]);
          let name = data[k].remark.slice(
            data[k].remark.search("#") + 1,
            data[k].remark.length
          );
          this.pcdd[0].object[i].name = name;
        }
        Object.assign(this.pcdd[0].object[11], data[data.length - 1]);
      }
    }
  },
};
