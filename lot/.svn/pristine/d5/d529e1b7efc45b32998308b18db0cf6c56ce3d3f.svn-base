...
export default {
  ...
  methods: {
    ...
    computed(data) {
      ...
      this.odd = this.getlist[0].object[this.selectItem].odd;
      this.getlist[0].object[this.selectItem].flag = true;
      this.leng = this.selectItem + 5;
    },
    type(key, i) {
      this.reset();
    ...
    go_to() {
      ...
      console.log('1:'+this.leng);
      console.log('2:'+this.arr.length);
