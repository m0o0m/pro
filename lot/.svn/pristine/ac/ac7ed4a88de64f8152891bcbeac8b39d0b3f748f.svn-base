...
use \libraries\balance\Dm_28Balance as dm28;
class Jnd_28Balance{
	const WIN   = 2;
    const FAIL  = 3;
    const DRAW  = 4;
    ...
    static $close       = 0;                ///封盘时间
    static $next_sec    = 180;        ///下期间隔

/**
      ***********************************************************
      *  总和大小单双 总和大单 大双 小单 小双  极小 极大        *
      ***********************************************************
*/
    public static function Balance_bet($result,$info){
        if($info[0] != 'jnd_28'){return static::FAIL;}
        return dm28::Balance_bet($result,$info);
    }
/**
      ***********************************************************
      *  获取期数                                               *
