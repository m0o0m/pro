	...
	function(e) {
		...
		return e.cookie.json = !0, t.templateSettings = {
			...
			initialize: function(t) {
				...
				}, t), this.lotteryId = this.options.lotteryId, this.isOpen = !0, this.isQuickMode = !0, this.setQuickMode(), this.refreshDuration = 120, this.amount = 0, this.data = [], this.records = [], this.betInfo = null, this.$doc = e(document), this.$play = e("#play"), this.PrePeriodNumber = null;
			...
			getPostData: function() {
				this.data = t.map(this.records, function(e, t) {
                    if(e.name == "特码包三"){
                        var _gname = e.category?e.category:(this.options.lotteryId=="pc_28"?"PC蛋蛋":'11111');
                        return {
                            id: e.id,
                            gname:_gname,
                            BetContext: $("#tmsb1").val()+","+$("#tmsb2").val()+","+$("#tmsb3").val(),
                            Lines: e.odds,
			...
			_renderIframe: function() {
				...
				n && (n.src = e.cfg.officalDomain.replace(/\/index\.php/g,"") + "/views/lottery/setiframe.html?height=" + t.body.clientHeight)
			}
		}), f
	});
